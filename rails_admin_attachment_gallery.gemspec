...
require "rails_admin_attachment_gallery/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "rails_admin_attachment_gallery"
  s.version     = RailsAdminAttachmentGallery::VERSION
  s.authors     = ["Aiman Najjar"]
  s.email       = ["aiman.najjar@hurranet.com"]
  s.homepage    = "http://github.com/aiman86/rails_admin_attachment_gallery"
